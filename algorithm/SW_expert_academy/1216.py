...
#             for part in range(100-point): #시작 점
#                 # for part in range(point): #확인 범위
#                 garo.append(datas[line][point : point + part]) #가로로 데이터
#                 sero.append(datas[point : point + part][line]) #세로로 데이터
